...
# Set external path where the database should be created
...
gilles = path_util.load_json(os.path.join(base_path, "Gilles_LesMiserables.json"))
...
def run_workflow(params: Dict, workflow_config: Dict):
    ...
    step1_path = book_base_path + params['title'] + '/step1_download_audio'
    step1_path_audio = step1_path + '/audio'
    step1_path_chapter = step1_path + '/chapter.csv'
    step2_path = book_base_path + params['title'] + '/step2_split_audio'
    step2_1_path = book_base_path + params['title'] + '/step2_1_audio_statistic'

    step2_path_audio = step2_path + '/audio'
    step3_path = book_base_path + params['title'] + '/step3_download_text'
    step3_path_text = step3_path + '/text.txt'
    step3_1_path = book_base_path + params['title'] + '/step3_1_prepare_text'
    step3_1_path_text = step3_1_path + '/text.txt'

    step4_path = book_base_path + params['title'] + '/step4_transcript_audio'
    step4_1_path = os.path.join(book_base_path + params['title'], "step4_1_normalize_transcript")
    step5_path = book_base_path + params['title'] + '/step5_align_text'
    step6_path = book_base_path + params['title'] + '/step6_finalize_dataset'
